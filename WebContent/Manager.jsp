...
<body>
	...
	<table border="1" align="center">
		...
		<tr>
			...
			%>
			<td><a href="<%=modifyPath%>">编辑 </a> <a href="<%=deletePath%>">删除</a>
			</td>
		</tr>
		<%
		    }
	...
	<form method="post"
		action="http://localhost:8080/ShopDemo/EditEmployeeHandler">
	...
	<div style="text-align: center">
		...
		<form action="<%=basePath + "QuerySellingStatus"%>">
			查询起始时间(yyyy-mm-dd)<input type="date" name="begindate" /> <br>
			查询结束时间(yyyy-mm-dd)<input type="date" name="enddate" /> <input
				type="submit" value="获取结果excel表" />
		</form>
